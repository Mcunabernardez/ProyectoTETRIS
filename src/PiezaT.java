...
public class PiezaT extends Pieza {
    Cuadrado central = new Cuadrado(200, 50, Color.blue);
    ...
    public boolean rotar() {
        ...
        switch (posicion) {
            case 0:
                ...
                cuadrados.get(3).setLocation(central.getX() + juego.getLADOCADRADO(), central.getY());
                posicion = 1;
            case 1:
                ...
                cuadrados.get(3).setLocation(central.getX(), central.getY() + juego.getLADOCADRADO());
                posicion = 2;
            case 2:
                cuadrados.get(0).setLocation(central.getX(), central.getY() + juego.getLADOCADRADO());
                cuadrados.get(2).setLocation(central.getX(), central.getY() - juego.getLADOCADRADO());
